...
/** 
	Demo program to create a simple ascii fits table 
...
*/
public class WriteFitsTableDemo2 {
	...
	public static void main(String[] args){
		try{
			...
			// The next constructor casts a BasicHDU as an AsciiTableHDU object
			// the java library inserts key, value/comments for TTYPE1, and TTYPE2
			// into the header that it creates for the data
			AsciiTableHDU tableHDU = (AsciiTableHDU) FitsFactory.hduFactory(data);
			...
			//  so adding as key/value/comments to insert them into header
